...
class Db
{
	...
	/**
	 * Spustí dotaz a vrátí všechny jeho řádky jako pole. Dále se předá libovolný počet dalších parametrů.
	 * @param string $query Dotaz
	 * @return mixed Group enbo false při neúspěchu
	 */
	public static function queryGroup($query) {
		$statement = self::executeStatement(func_get_args());
